...
_STOP_WORDS = (
    [
        ...
        'еще', 'нет', 'из', 'ему', 'теперь', 'даже', 'ну', 'вдруг', 'ли', 'если', 'уже', 'или', 'ни',
        'был', 'него', 'до', 'вас', 'нибудь', 'опять', 'уж', 'вам', 'ведь', 'там', 'потом', 'себя', 'ничего',
        'ей', 'они', 'тут', 'ней', 'для', 'мы', 'тебя', 'их', 'чем', 'была', 'сам',
        'чтоб', 'без', 'будто', 'чего', 'раз', 'тоже', 'себе', 'под', 'ж', 'тогда', 'этот', 'того',
        'потому', 'этого', 'какой', 'совсем', 'ним', 'здесь', 'этом', 'один', 'почти', 'мой', 'тем', 'чтобы', 'нее',
        'сейчас', 'были', 'всех', 'никогда', 'можно', 'при', 'наконец', 'два', 'другой', 'хоть',
        'после', 'над', 'больше', 'тот', 'через', 'эти', 'про', 'всего', 'них', 'какая', 'много', 'разве',
        'три', 'эту', 'моя', 'впрочем', 'хорошо', 'свою', 'этой', 'перед', 'иногда', 'лучше', 'чуть', 'том', 'нельзя',
        'такой', 'им', 'более', 'всегда', 'конечно', 'всю', 'между',
    ]
    + ['the', 'a', 'an', 'and', 'or', 'but', 'in', 'on', 'at', 'to', 'for', 'of', 'with', 'about', 'is', 'it']
    + ['der', 'die', 'das', 'ein', 'eine', 'und', 'oder', 'aber', 'auf', 'zu']
    + ['le', 'la', 'les', 'un', 'une', 'et', 'ou', 'mais', 'dans', 'sur', 'à', 'pour', 'de']
)
...
_INDEX_SETTINGS = {
    ...
    'filterableAttributes': [
        ...
        'isfolder', 'searchable', 'hidemenu', 'published_year',
        'publishedon', 'lang',
    ],
    'sortableAttributes': [
    ...
    'displayedAttributes': [
        'id', 'pagetitle', 'parent_title', 'breadcrumbs',
        'published_year', 'description', 'introtext',
        'alias', 'url_path', 'publishedon', 'lang',
    ],
...
class MeilisearchProvider(BaseSearchProvider):
    ...
    async def search(
        ...
        try:
            result = await asyncio.to_thread(self._index.search, normalized_query, opt_params)
